...
namespace PathologicalGames
{
    ...
    public class EventFireController : MonoBehaviour
    {
		...
		public Transform spawnEventTriggerAtTransform
		{
			get 
			{
				// For inspector or just-in-time access
				if (this.xform == null)
		...
		/// <summary>
		/// A cached reference to this FireController's Transform
		/// </summary>
        ...
        protected void Awake()
        {
			...
			// Note 'this.targetTracker' is initilized when the firing system starts to allow 
			//	TargetTrackers to be created by code and still set 'targetTracker'
        }
