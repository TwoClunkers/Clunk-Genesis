...
public class ConstraintBaseClass : ConstraintFrameworkBaseClass
{
    ...
    [SerializeField]
	protected UnityConstraints.NO_TARGET_OPTIONS _noTargetMode =
    ...
    /// 'Align' is chosen, the constraint will align once then go to sleep.
    /// </summary>
    // Public backing field for the inspector (The underscore will not show up)
    ...
    [SerializeField]
	protected UnityConstraints.MODE_OPTIONS _mode = UnityConstraints.MODE_OPTIONS.Constrain;
