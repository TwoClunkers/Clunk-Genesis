...
public class LookAtBaseClass : ConstraintBaseClass
{
    ...
    /// This is public for user input only, should not be used by derived classes
    /// </summary>
    public Vector3 pointAxis = -Vector3.back;

    /// <summary>
    /// The axis to stabalize the look-at result so it doesn't roll on the point axis. This should 
	///     never be the same as the pointAxis.   
    /// This is public for user input only, should not be used by derived classes
    /// </summary>
