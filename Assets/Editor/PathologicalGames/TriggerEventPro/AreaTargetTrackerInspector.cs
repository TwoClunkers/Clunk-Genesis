...
public class AreaTargetTrackerInspector : Editor
{
	...
	public override void OnInspectorGUI()
    {
		...
		if (EditorGUI.EndChangeCheck())
		{
			...
			Undo.SetSnapshotTarget(targetObjs, targetObjs[0].GetType() + " sortingStyle");
		    Undo.CreateSnapshot();
        ...
        if (this.showArea)
        {
			...
			{				
#if UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2
			    Undo.SetSnapshotTarget(targetObjs, targetObjs[0].GetType() + " areaLayer");
			    Undo.CreateSnapshot();
...
#if UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2
				Undo.SetSnapshotTarget(targetObjs, undo_message);
				Undo.CreateSnapshot();
...
//						}
						...
						Undo.RecordObject(curEditTarget.area.xform, undo_message);						
					}
...
class AreaGizmo
{
    ...
    static void RenderAreaGizmo(AreaTargetTracker tt, GizmoType gizmoType)
    {
		...
		if (
			    ...
			    tt.area != null && 
	            (
					(tt.area.coll != null && !tt.area.coll.enabled) 
#if (!UNITY_4_0 && !UNITY_4_0_1 && !UNITY_4_1 && !UNITY_4_2)
	             || (tt.area.coll2D != null && !tt.area.coll2D.enabled)
#endif
				)
